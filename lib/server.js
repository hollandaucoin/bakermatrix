...
app.use(session({
  ...
  // Refresh the 30-day expiry on every request so active users never hit it.
  rolling: true,
  resave: false,
...
// Icons and favicon always come from public/ so they stay current before the next build.

 ...
 */
SeniorCounselor.statics.create = async function({ name, username, gender, committee, committeeLead, _jcPairing, _jcPairing2, _associatedSchool, _previousSchools, _previousPostingPartner } = {}) {
  try {
 ...
 */
SeniorCounselor.methods.update = async function({ name, username, gender, committee, committeeLead, _jcPairing, _jcPairing2, _associatedSchool, _previousSchools, _previousPostingPartner, federalWay } = {}) {
  try {
